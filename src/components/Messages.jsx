                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="message-text">
                                ...
                                <SectionTitle SectionTitleClass="mb-40 text-start" title="Shaping the Future with Technology" subtitle="Talk to us"/>
                                ...
                                <form action="#" className="message-form">
                                    <div className="row g-3">
                                        ...
                                        <div className="col-lg-12">
                                            <div className="input-group">
                                                <label className="form-label">Your Area</label>
                                                <textarea className="form-field textarea-control"
