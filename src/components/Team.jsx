                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-7 mx-auto">
                            <SectionTitle SectionTitleClass="text-center" title="Technology that Moves You Forward" subtitle="Creative Members"/>
                        </div>
                    </div>

                    {/* teams data loop start */}
                                        ...
                                        <div className="col-lg-4 col-md-5 align-self-center">
                                            <div className="social-icon-box">
                                                <ul className="list-unstyled">
                                                    <li>
                                                        <a href="#" className="d-inline-flex justify-content-center align-items-center">
